...
<div class="people-grid">
  ...
  <div class="person-card">
    ...
    <div class="person-links">
      ...
      <a class="icon-badge" href="https://it.linkedin.com/in/andrea-serani" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        <img src="../assets/icons/linkedin.svg" alt="LinkedIn">
      </a>
    </div>
  </div>
  ...
  <div class="person-card">
    ...
    <p class="person-role">Research Scientist</p>
    <div class="person-links">
      <a class="icon-badge" href="https://it.linkedin.com/in/giorgio-palma" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        <img src="../assets/icons/linkedin.svg" alt="LinkedIn">
      </a>
    </div>
  </div>
  ...
  <div class="person-card">
    ...
    <div class="person-links">
      <a class="icon-badge" href="https://orcid.org/0000-0003-3920-8434" target="_blank" rel="noopener noreferrer" aria-label="ORCID">
        <img src="../assets/icons/orcid.svg" alt="ORCID">
      </a>
      <a class="icon-badge" href="https://www.linkedin.com/in/dr-avinita-gautam-83b427120" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        <img src="../assets/icons/linkedin.svg" alt="LinkedIn">
      </a>
    </div>
  </div>
