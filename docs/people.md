...
<div class="people-grid">
  ...
  <div class="person-card">
    ...
    <p class="person-role">Postdoctoral Research Fellow</p>
    <div class="person-links">
  ...
  <div class="person-card">
    <img src="../assets/people/sofia-sammarco.jpg" alt="Sofia Sammarco" class="person-photo">
    <h3>Sofia Sammarco</h3>
...
<!-- Add PhD Fellows / MSc / BSc students -->

---

## Alumni

- Name Surname — PhD Fellow, now [position]
- Name Surname — MSc Student, now [position]
- Name Surname — BSc Student, now [position]

---

## Former Senior Staff

- **Emilio F. Campana** — Former Research Director, pioneer of the research line; currently Director of Department, CNR-DIITET
